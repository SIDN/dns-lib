 ...
 *
 * <p>
 * The normalized values will be returned from {@link #toString()} and {@link #parts()}, and will be
 * reflected in the result of {@link #equals(Object)}.
 *
 * <p>
...
public final class InternetDomainName {
   ...
   *
   * <p>
   * For considerations on whether the public suffix or registry suffix designation is more suitable
   * for your application, see
   * <a href="https://github.com/google/guava/wiki/InternetDomainNameExplained">this article</a>.
   *
   ...
   *
   * <p>
   * This method can be used to determine whether it will probably be possible to set cookies on the
   ...
   *
   * <p>
   * This method can be used to determine whether a domain is probably the highest level for which
   ...
   * {@linkplain #isPublicSuffix() public suffix}. For example, for {@code x.adwords.google.co.uk}
   * it returns {@code google.co.uk}, since {@code co.uk} is a public suffix. Similarly, for {@code
   ...
   *
   * <p>
   * This method can be used to determine the probable highest level parent domain for which cookies
  ...
  /**
   * Returns the portion of this domain name that is one level beneath the
   * {@linkplain #isRegistrySuffix() registry suffix}. For example, for
   * {@code x.adwords.google.co.uk} it returns {@code google.co.uk}, since {@code co.uk} is a
   * registry suffix. Similarly, for {@code
