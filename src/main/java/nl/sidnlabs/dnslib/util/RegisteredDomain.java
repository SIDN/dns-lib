...
/*
 * Copyright (c) 2017, 2018, Oracle and/or its affiliates. All rights reserved. ORACLE
 ...
 * <p>
 * The primary purpose of this class is to determine if domains are safe to use in various
 * use-cases.
 */
public interface RegisteredDomain {
  ...
  /**
   * Returns an {@code Optional<RegisteredDomain>} representing the registered part of the specified
   * domain.
   *
   * @param domain the domain name
   * @return an {@code Optional<RegisteredDomain>}; the {@code Optional} is empty if the domain is
   *         unknown or not registerable
